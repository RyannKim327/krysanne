...
Welcome to **Mayie**, an empathetic AI Telegram companion designed to offer listening, conversation, and supportive presence. Your privacy and trust are of utmost importance, especially given our mission to provide comfort, combat loneliness, and offer a safe space for expression.
...
**Mayie is an AI companion chatbot. It is NOT a licensed medical, mental health, or psychiatric professional service.** 

*   **Not a Replacement for Professional Help:** Mayie cannot diagnose, treat, or prevent mental health conditions, and cannot provide clinical crisis intervention.
...
2.  **Conversational History:** The text of messages you send to Mayie, along with the assistant's replies.

*No other personal data (such as your real name, phone number, location, or payment details) is requested, processed, or stored by Mayie.*
...
*   **Conversational Continuity (Context):** Storing previous messages in the secure GitHub Secret Gist allows Mayie to remember what was said earlier, facilitating natural, continuous, and supportive dialogue.
...
We utilize the following third-party integrations to run Mayie:
...
Mayie is open-source software distributed under the [Educational Community License, Version 2.0 (ECL-2.0)](LICENSE.md).
...
*   **GitHub Repository:** [RyannKim327/mayie](https://github.com/RyannKim327/mayie)
